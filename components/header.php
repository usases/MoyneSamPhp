  ...
  <div class="container mx-auto px-4 py-3 flex justify-between items-center">
    ...
    <nav>
      <ul class="flex space-x-6">
        <?php if ($currentUser): ?>
          <li>
            <a href="\Moyne Sam\requestsPage.php" class="hover:text-blue-200 transition-colors">
              Мои заявки
            </a>
          </li>
          <?php if (!empty($currentUser['is_admin'])): ?>
            <li>
              <a href="\Moyne Sam\components\admin.php" class="hover:text-blue-200 transition-colors">
                Админ панель
              </a>
            </li>
          <?php endif; ?>
